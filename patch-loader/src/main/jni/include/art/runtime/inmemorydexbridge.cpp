...
static const char* kOpenMemoryArm64 =
...
static const void* openMemory(
    ...
    OpenMemoryArm64 fn =
        reinterpret_cast<OpenMemoryArm64>(symbol);
...
static jobject openBytes(
...

    {
        ...
        gMemory[reinterpret_cast<uintptr_t>(dexFile)] =
            { mapping, size };
    }
...
Java_dalvik_system_DexFile_createCookieWithDirectBuffer(
        JNIEnv* env,
        jclass,
        jobject buffer,
        jint start,
    ...
    if (address == nullptr || capacity < 0) {
        throwIOException(
            env,
            "ByteBuffer is not a direct buffer");
        return nullptr;
    }
...
extern "C"
JNIEXPORT jobject JNICALL
Java_dalvik_system_DexFile_createCookieWithArray(
        JNIEnv* env,
        jclass,
        jbyteArray array,
        jint start,
    ...
    env->GetByteArrayRegion(
        ...
        reinterpret_cast<jbyte*>(temp.data()));
